...
namespace StarterAssets
{
    ...
    public class ThirdPersonController : MonoBehaviour
    {
        ...
        private void SetPlayerRotationWhileAiming()
        {
            Vector3 rotation = _mainCamera.transform.forward;
            float yRotation = Mathf.Atan2(rotation.x, rotation.z) * Mathf.Rad2Deg;
